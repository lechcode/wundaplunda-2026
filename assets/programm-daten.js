...
const WUNDA = {
  ...
  programm: [
    ...
    { tag:"mo", zeit:"14:30 – 16:00", titel:"Seifenblasen", wo:"Treffpunkt Wundazelt", wen:["kinder_0_4","kinder_ab_5"] },
    ...
    { tag:"di", zeit:"10:30 – 12:30", titel:"Knotenkunde & Tarpaufbau", wo:"Treffpunkt Wundazelt", wen:["erwachsene"] },
    ...
    { tag:"mi", zeit:"19:30 – 21:00", titel:"Tribubu - World Music Band", wo:"Zirkuszelt", wen:["alle"] },
    { tag:"mi", zeit:"Ganztags", titel:"Waldrallye · Spielewagen · Flying Fox", wo:"", wen:["alle"] },
    // Donnerstag
    ...
    { tag:"do", zeit:"16:30 – 18:00", titel:"Frauenkreis – Weibliche Lebendigkeit", wo:"Yogaraum", wen:["erwachsene"] },
    ...
    { tag:"do", zeit:"15:30 – 16:30", titel:"ContaKids - Bewegung, Spiel & Verbindung", wo:"Turnhalle", wen:["kinder_0_4"], status:"entfaellt" },
    ...
    { tag:"sa", zeit:"10:30 – 11:15", titel:"Kids Singen, Tanzen, Bewegen", wo:"Zirkuszelt", wen:["kinder_0_4"] },
  ...
  katalog: {
    ...
    "Kuchen Pappelkinder & Hoflädle": {
      ...
      beschreibung: "Kommt hoch zum Dorfplatz! \nMit Kinderschminken und Kuchen der Pappelkinder (Verein Natürlich Miteinander e.V.).",
    },
    Frauenkreis: {
      wer: "Fabienne (Gemeinschaft Sulzbrunn)",
      foto: "frauenkreis.png",
    ...
    "Männerkreis": {
      ...
      beschreibung: "„Der Kreis erinnert uns daran: Wir müssen unseren Weg nicht allein gehen.“\nDem Leben mit offenem Herzen begegnen.\nAn diesen beiden Abenden öffnen wir gemeinsam einen Begegnungsraum für uns Männer. Einen Raum der Kreiskultur, des gemeinsamen Forschens und der ehrlichen Begegnung. Mit kleinen Impulsen und offenem Herzen wollen wir uns selbst, dem anderen und der Lebendigkeit ein Stück näher kommen. Es geht nicht darum, fertige Antworten zu finden, sondern gemeinsam Fragen zu stellen, zuzuhören und uns daran zu erinnern, dass wir unseren Weg nicht alleine gehen müssen.\n\nÜber mich, Oliver: \n\n\"Ich öffne Räume, in denen Menschen sich selbst,\ndem anderen und dem Leben begegnen dürfen.\"\nIch glaube daran, dass wir Menschen Räume brauchen, in denen wir uns wieder wirklich begegnen\nkönnen – ehrlich, achtsam und auf Augenhöhe. Männerkreise sind für mich solche Räume.\nMir ist eine Kultur des Miteinanders wichtig, in der wir einander zuhören, uns zeigen dürfen und\ngemeinsam erforschen, was uns als Männer bewegt und stärkt. Dabei geht es weniger um fertige Antworten als vielmehr um Präsenz, Verbundenheit und die Erfahrung, dass wir mit unseren Themen nicht allein sind.\nIch begleite diese Räume mit Bodenständigkeit, Offenheit und einer liebevollen Haltung. Durch kleine Impulse und gemeinsames Erforschen darf entstehen, was gerade da ist – lebendig, menschlich und getragen von der Kraft des Kreises.\nOliver Weickert",
    },
    ...
    "Kinderschminken (Spende)": {
      wer: "Verein Natürlich Miteinander e.V.",
      beschreibung: "Ihr unterstützt den Verein Natürlich Miteinander e.V.",
    },
    Jodeln: {
      wer: "Amelie Zech",
      beschreibung: "Heute muss ContaKids leider wegen Krankheit entfallen. Was gibt dafür andere Angebote, z.B. Jodeln mit Amelie",
    },
  },
  ...
  verpflegung: {
    ...
    preise_essen: [
      { gruppe:"Mittags", name:"Pizza Ø 40 cm Rucola mit Feta & Oliven", preis:"14 €" },
      { gruppe:"Mittags", name:"Pizza Ø 40 cm Rucola – ½ Pizza", preis:"8 €" },
      { gruppe:"Mittags", name:"Pizza Ø 40 cm Margherita mit Tomaten", preis:"13 €" },
      { gruppe:"Mittags", name:"Pizza Ø 40 cm Margherita – ½ Pizza", preis:"7 €" },
      { gruppe:"Mittags", name:"Tagesgericht (siehe Tagesgerichtkarte)", preis:"10 €" },
      { gruppe:"Mittags", name:"Tagesgericht Kinderportion", preis:"6 €" },
      { gruppe:"Mittags", name:"Beilagensalat (2 versch. Rohkost & grüner Salat)", preis:"4 €" },
      { gruppe:"Mittags", name:"Nachtisch: Rote Grütze / Agua Fresca mit Wassermelone", preis:"3 €" },
      { gruppe:"Abends", name:"Tagesgericht / Suppe (siehe Tagesgerichtkarte)", preis:"6 €" },
      { gruppe:"Abends", name:"Pommes mit Mayo & Ketchup", preis:"5 €" },
      { gruppe:"Abends", name:"Beilagensalat (2 versch. Rohkost & grüner Salat)", preis:"4 €" },
    ],
    getraenke: [
      { gruppe:"Bio Bier in Flaschen (alles alkoholfrei)", name:"Lammsbräu Naturradler 0,33 l", preis:"3,00 €" },
      { gruppe:"Bio Bier in Flaschen (alles alkoholfrei)", name:"Lammsbräu Dunkel Zitrone 0,33 l", preis:"3,00 €" },
      { gruppe:"Bio Bier in Flaschen (alles alkoholfrei)", name:"Lammsbräu Dunkel 0,33 l", preis:"3,00 €" },
      { gruppe:"Bio Bier in Flaschen (alles alkoholfrei)", name:"Härle Freies Gold 0,5 l", preis:"3,50 €" },
      { gruppe:"Bio Schorlen/Limonaden in Flaschen (alles alkoholfrei)", name:"Apfelsaftschorle NOW 0,5 l", preis:"3,00 €" },
      { gruppe:"Bio Schorlen/Limonaden in Flaschen (alles alkoholfrei)", name:"Seezüngle (Träuble, Kirsche, Rhabarber, Birne) 0,33 l", preis:"2,50 €" },
      ...
      { gruppe:"Bio Schorlen/Limonaden in Flaschen (alles alkoholfrei)", name:"Sprudelwasser 1 l", preis:"2,50 €" },
      { gruppe:"Fair Trade und Bio Kaffee", name:"Cappuccino Kuh-/Haferbaristamilch", preis:"3,50 €" },
      { gruppe:"Fair Trade und Bio Kaffee", name:"Cappuccino Kuh-/Haferbaristamilch doppio", preis:"5,00 €" },
      { gruppe:"Fair Trade und Bio Kaffee", name:"Espresso/Americano", preis:"2,50 €" },
      { gruppe:"Fair Trade und Bio Kaffee", name:"Espresso/Americano doppio", preis:"3,00 €" },
      { gruppe:"Fair Trade und Bio Kaffee", name:"Espresso Afogato (+ 1 Kugel Eis)", preis:"5,00 €" },
      { gruppe:"Fair Trade und Bio Kaffee", name:"Tee (verschiedene Sorten)", preis:"2,50 €" },
      { gruppe:"Fair Trade und Bio Kaffee", name:"Heiße Schokolade", preis:"4,00 €" },
      { gruppe:"Bio Eis & Bio Waffeln/Stockbrotteig", name:"verschiedene Sorten Eis (auch vegan)", preis:"3,50 €" },
      { gruppe:"Bio Eis & Bio Waffeln/Stockbrotteig", name:"Waffeln mit Apfelmus", preis:"3,00 €" },
      { gruppe:"Bio Eis & Bio Waffeln/Stockbrotteig", name:"Waffeln mit Puderzucker", preis:"2,50 €" },
      { gruppe:"Bio Eis & Bio Waffeln/Stockbrotteig", name:"Stockbrot-/Calzone-Teig", preis:"1,50 €" },
    ],
    tagesgerichte: [
      { tag:"Montag 03.08.2026", mittag:"Kichererbsencurry mit Reis und vegane Raita", abend:"Chili mit Takkos & Baguette (ww. Schmand)" },
      { tag:"Dienstag 04.08.2026", mittag:"Ratatouille mit Reis oder Nudeln", abend:"Erbsen-Kokossuppe mit Baguette · Spätzle mit Soße" },
      { tag:"Mittwoch 05.08.2026", mittag:"Aloo Gobi (indisches Blumenkohl-Kartoffel-Curry) mit Reis und Raita", abend:"Gemüseeintopf mit Baguette · Nudeln mit Tomatensoße" },
      { tag:"Donnerstag 06.08.2026", mittag:"Penne mit veganer Bolognese", abend:"Tomatensuppe (ww. Schmand) und Baguette · Spätzle mit Soße" },
      { tag:"Freitag 07.08.2026", mittag:"veganes Pilzgeschnetzeltes mit Reis oder Spätzle", abend:"Zucchinisuppe · Nudeln mit Tomatensoße" },
      { tag:"Samstag 08.08.2026", mittag:"Risotto", abend:"" },
    ],
